...
-- Insert data into the governance_data table
INSERT INTO governance (CompanyID, ReportYear, BoardSize, IndependentDirectors, FemaleDirectorsPercentage, ExecutiveCompensationUSD, AntiCorruptionPolicy)
VALUES
